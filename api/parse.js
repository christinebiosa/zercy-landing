...
- If user mentions hotel / Unterkunft / accommodation / stay / übernachten / Hotelzimmer / alojamiento / hébergement → add: "hotel": { "destination": "city name", "name": "ONLY set when the user explicitly wants to book/stay AT a specific named property ('I want the Ritz', 'book me the Four Seasons', 'stay at the Mandarin'). Short form: 'Ritz Paris', 'Four Seasons Paris'. DO NOT set for area/proximity searches: 'near the Ritz', 'close to X', 'around X', 'hotels like X' — those are area searches, not property bookings. Default: null.", "checkin": "YYYY-MM-DD or null", "checkout": "YYYY-MM-DD or null" }
