...
metaTitle: "Hidden city ticketing explicado: qué es y qué | Zercy"
...
- Solo llevas equipaje de mano (explicado abajo)
- Es un vuelo one-way (sin billete de vuelta en el mismo PNR)
- No es un destino donde viajas con frecuencia con la misma aerolínea (no te interesa el programa de fidelidad)
- El ahorro es significativo (más de 100 euros) y justifica el riesgo

**Situaciones donde NO funciona o tiene riesgos serios:**
- **Llevas maleta facturada**: el equipaje se factura hasta el destino final del billete. Si te bajas en la escala, tu maleta continúa al destino final sin ti. No hay forma de recuperarla sin complicaciones.
- **Billete de ida y vuelta en el mismo PNR**: si no usas el primer tramo del viaje de regreso (porque ya estás en casa), la aerolínea puede cancelar el resto del billete. Esto puede invalidar el vuelo de regreso que compraste.
- **Viajero frecuente**: las aerolíneas monitorizan el uso de esta práctica. Pueden suspender la cuenta de viajero frecuente si detectan un patrón repetido.
- **Vuelo con conexión ajustada**: si el vuelo llega tarde, la aerolínea te puede "proteger" en el siguiente vuelo a Austin en lugar de dejarte en Dallas.

## La herramienta que lo automatiza

El sitio [Skiplagged](https://skiplagged.com) automatiza la búsqueda de hidden city tickets, mostrando directamente los vuelos donde esta técnica puede ahorrar dinero. Desde su lanzamiento, ha sido demandado por United Airlines y Orbitz (sin éxito legal significativo), lo que da una idea de cómo ven las aerolíneas esta práctica.
...
## ¿Es legal el hidden city ticketing?
...
- Penalización en el programa de fidelidad
- Cancelación de billetes futuros en el mismo PNR
- En casos extremos, bloqueo de la cuenta de viajero frecuente
