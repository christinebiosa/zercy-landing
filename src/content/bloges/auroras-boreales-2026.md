...
**Índice Kp:** el indicador principal de actividad geomagnética. Escala de 0 a 9. Con Kp de 3-4 se ven auroras en el Círculo Polar. Con Kp de 5-7 (tormenta geomagnética) se pueden ver en latitudes más bajas (Escocia, norte de Alemania, incluso España en eventos extremos). El [Space Weather Prediction Center](https://www.swpc.noaa.gov/products/planetary-k-index) de la NOAA publica predicciones de 3 días.
...
Zercy puede ayudarte a organizar el viaje para ver auroras boreales. Guarda tu itinerario en el [Zercy Logbook](https://www.zercy.app/logbook).
