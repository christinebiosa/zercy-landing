...
**Top picks:** The Charlee Hotel (designer boutique with rooftop pool), Click Clack Hotel (boutique premium), Hotel Estelar Milla de Oro (modern 5-star with pool). These and 1,000+ more Medellín hotels are on [Booking.com](https://www.booking.com) with neighborhood filter and USD-fixed prices.
...
Medellín has eternal-spring climate (65-82°F year-round) and two rainy phases. The [official ProColombia tourism authority](https://colombia.travel/en/medellin) has a detailed event calendar and hotel recommendations.
...
For Medellín [Booking.com](https://www.booking.com) is clearly the best platform:

- Over 1,000 hotels and apartments in Medellín listed
- Filter "neighborhood" shows Poblado, Laureles, Envigado etc. directly
- Reviews very reliable (digital nomad travelers critical of WiFi speed)
- USD-fixed prices protect against peso fluctuations
- Filter "pool" important (Medellín spring warmth)
- Filter "WiFi speed" available (essential for workation)
...
If you're planning Medellín, just describe what you want to Zercy (first visit, workation, foodie, family). You get suggestions with concrete hotels in fitting neighborhoods plus booking links. Save the shortlist in your [Zercy Logbook](https://www.zercy.app/logbook) so you have all options handy when booking.
