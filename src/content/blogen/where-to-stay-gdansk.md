...
These and 500+ more Gdańsk hotels are on [Booking.com](https://www.booking.com) with a map filter by neighborhood.
...
**May and September** are ideal. Warm enough for the beach, smaller crowds, lower hotel prices. The [official Visit Gdańsk website](https://visitgdansk.com) publishes up-to-date event calendars and neighborhood guides.
...
The SKM commuter train runs from Sopot to Gdańsk Old Town station in 20 minutes. The [Visit Gdańsk tourism website](https://visitgdansk.com) has interactive maps for all three Trójmiasto cities.
