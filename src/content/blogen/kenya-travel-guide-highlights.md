...
Kenya requires an e-Visa for most nationalities including EU and US citizens. Apply online at [etakenya.go.ke](https://www.etakenya.go.ke). Cost is around $51 USD for a single-entry visa. Apply at least a week before departure.
...
Use the [Zercy Logbook](https://www.zercy.app/logbook) to plan your safari, internal flights and beach stay as a single connected itinerary. Save your shortlist and compare options in one place.
