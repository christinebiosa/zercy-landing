...
**North-to-south route (4-6 weeks):**
Bangkok → Chiang Mai → Laos (Luang Prabang, Vang Vieng) → Hanoi → Halong Bay → Hoi An → Ho Chi Minh City → Cambodia (Siem Reap, Phnom Penh)

**South-to-north route (easier entry):**
...
For multi-stop trip planning, the [Zercy Logbook](https://www.zercy.app/logbook) keeps all cities and connections in one place.
...
Tell Zercy where in Southeast Asia you want to go and how long you have. You will get specific route suggestions, flight connections from your departure city, and accommodation ideas for each stage. Save the shortlist in your [Zercy Logbook](https://www.zercy.app/logbook) so you have all options handy when booking.
