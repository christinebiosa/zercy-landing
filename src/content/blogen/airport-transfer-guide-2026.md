...
1. **Only get into official taxi queues or designated Uber/Grab/Bolt pickup zones.** At Heathrow this is the ground floor of each terminal. In Bangkok there is a separate queue for metered taxis.

2. **Meter on before departure.** In almost every country, riding without a meter is either illegal or a scam. Bangkok: "No meter" always means a scam. Paris: flat rates to and from the airport are legal and clearly posted.
...
**Aggregators like [Rome2rio.com](https://www.rome2rio.com)** show all options (train, bus, taxi, flight) for any route worldwide including price estimates. Good for planning, but always check prices directly with the provider before booking.
...
Tell Zercy your airport and destination. You get the best transfer option for your situation, whether train, Uber, or private van. Save the shortlist in your [Zercy Logbook](https://www.zercy.app/logbook) so you have all options handy when booking.
