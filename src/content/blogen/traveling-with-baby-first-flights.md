...
The [American Academy of Pediatrics](https://www.aap.org/en/patient-care/healthy-children-magazine/) has a detailed guide on traveling with infants, including recommendations on vaccinations and medications.
...
If you're planning the first trip with baby, just describe what you want to Zercy (family-friendly, short flight, direct beach). You get suggestions with child-appropriate hotels and direct connections plus booking links. Save the shortlist in your [Zercy Logbook](https://www.zercy.app/logbook) so you have all options handy when booking.
