...
- **Cube 1**: Upper body (t-shirts, shirts, tops)
- **Cube 2**: Lower body (pants, shorts)
- **Cube 3**: Underwear and socks
- **Cube 4**: Cables, chargers, small tech

If you need pants at the hotel in the evening, you open Cube 2. Done. No digging.

The second benefit: cubes compress. Compression cubes in particular (from [Eagle Creek](https://www.eaglecreek.com/collections/pack-it) or Osprey, for example) cut soft clothing volume in half. A t-shirt laid flat at 3 cm height compresses to about 1.5 cm.
...
- 3 tops or t-shirts (synthetic or merino, not cotton)
- 2 pairs of pants (one casual, one semi-smart)
- 1 dress or smart-casual top (for restaurants, evenings)
- 5 pairs of underwear (merino dries overnight)
- 3 pairs of socks (enough with washing)
- 1 light jacket (softshell or packable down)
...
For packing lists that adapt to your destination and trip length, [PackPoint](https://www.packpnt.com/) generates automatic lists based on weather and planned activities. Free, works offline.
...
Zercy helps you plan the trip before you start packing. When you know the destination, the weather, and the duration, you pack more precisely. Build your shortlist and save it in your [Zercy Logbook](https://www.zercy.app/logbook) so you have all options ready when it's time to book.
