...
On [Booking.com](https://www.booking.com) you'll find many small ryokan in Asakusa that are otherwise hard to book. The official Tokyo tourism board [Go Tokyo](https://www.gotokyo.org/en/destinations/eastern-tokyo/asakusa/index.html) additionally has a curated overview of authentic ryokans.
...
- Over 3,500 hotels and ryokan listed
- Filter "neighborhood" shows Shinjuku, Shibuya etc. directly
- Reviews from actual guests, very reliable
- Free cancellation as standard, especially valuable in Tokyo due to often strict hotel rules
- Translation service with hotel if needed (Japanese is otherwise a hurdle)
