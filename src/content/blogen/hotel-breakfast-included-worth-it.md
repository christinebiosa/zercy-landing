...
The trick is simple. Go to [Booking.com](https://www.booking.com) and look at both rates side by side: room with breakfast and room without. The difference is the effective breakfast price.
...
Zercy shows you hotel options with and without breakfast side by side, so you're not guessing when you book. Save your shortlist in the [Zercy Logbook](https://www.zercy.app/logbook) so you have all options handy when booking.
