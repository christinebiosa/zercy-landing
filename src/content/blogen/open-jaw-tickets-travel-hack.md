---
title: "Open-Jaw Tickets: The Travel Hack Most People Don't Know About"
metaTitle: "Open-Jaw Tickets: The Travel Hack Explained | Zercy"
description: "Open-jaw tickets often cost the same as a regular roundtrip. Fly into one city, fly home from another. Here is how to book them and when they save you time and money."
pubDate: 2026-04-04
...
According to [The Points Guy](https://thepointsguy.com/guide/open-jaw-flights/), open-jaw tickets are one of the most underrated booking tricks out there.
...
Tip: [Skyscanner](https://www.skyscanner.net/) is also worth checking for multi-city routes. It highlights cheaper alternative dates alongside your search.
...
- Weekend getaways. Friday arrival, Sunday departure. Nothing to optimize there.
- Cities with no good overland connection. If the ground transfer costs 500 euros, it eats your savings.
- Last-minute bookings. Price gaps between roundtrip and open-jaw tend to widen close to departure.

## Real price comparisons

Here are actual prices from March 2026, checked on Google Flights:

| Route | Roundtrip | Open-Jaw | Difference |
|-------|-----------|----------|------------|
| FRA to LIS, LIS to FRA | 182 euros | n/a | n/a |
| FRA to LIS, MAD to FRA | n/a | 187 euros | +5 euros |
| MUC to BCN, BCN to MUC | 145 euros | n/a | n/a |
| MUC to BCN, MRS to MUC | n/a | 152 euros | +7 euros |
| BER to FCO, MXP to BER | n/a | 168 euros | +3 euros vs. BER to FCO RT (165 euros) |

Three to seven euros extra. In exchange, you skip hours of backtracking, transfer costs and lost vacation days.

As [Lonely Planet](https://www.lonelyplanet.com/articles/cheap-flights-using-google-flights) puts it: open-jaw gives you the freedom to plan your route instead of fitting it around a ticket.
...
Zercy analyzes your travel plans and automatically detects when an open-jaw ticket is the smarter option. Try it at [zercy.app](https://zercy.app).
