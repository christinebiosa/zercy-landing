...
- **Direct flights** from major European hubs to San José or Liberia (approx. 11–13 hours). Liberia works better if you're heading straight to the Nicoya Peninsula.
- **Best base**: Use San José only as a transit point — there's little to see. Head straight to the coast or the rainforest.
- **Car rental**: Book in advance from international companies with solid coverage. Local agencies can be cheaper but inconsistent on insurance.
