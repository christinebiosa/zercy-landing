...
**Alone or with an operator?** Without a local operator a safari is almost impossible to organize sensibly. The logistics (flights, permits, transfers, camps) are too complex. Well-reviewed operators can be found on [SafariBookings.com](https://www.safaribookings.com) or [Africa Travel Resource](https://www.africatravelresource.com). Both have independent traveler reviews.
...
Plan your flight and accommodation selection with Zercy and save everything in your [Zercy Logbook](https://www.zercy.app/logbook) so nothing gets lost when booking.
