...
**Top picks:** Hotel Yak & Yeti (classic, luxury, garden), Kantipur Temple House (boutique in a Newari temple building), Hotel Encounter Nepal (well-equipped for trekkers). These and 300+ more Kathmandu hotels are on [Booking.com](https://www.booking.com) with neighborhood filter.
...
The [Nepal Tourism Authority](https://www.tourismdepartment.gov.np/) lists accredited hotels by zone and has up-to-date information on current trekking permit requirements.
...
For Kathmandu, [Booking.com](https://www.booking.com) is an excellent platform:
