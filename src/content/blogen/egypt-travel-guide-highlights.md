...
**Cairo and the Pyramids of Giza** are the obvious starting point. The three main pyramids, the Sphinx and the Grand Egyptian Museum (opened 2023) together are worth a full day, at minimum. The [Grand Egyptian Museum](https://gem.gov.eg) near Giza displays the complete collection from Tutankhamun's tomb: over 5,000 objects after decades of restoration. Don't skip it.
...
Plan your Egypt trip with the [Zercy Logbook](https://www.zercy.app/logbook). Combine Cairo, a Nile cruise and the Red Sea into one route, comparing flight and accommodation options in one overview.
