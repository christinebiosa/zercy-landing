...
**Switzerland, Norway, Iceland:** Similar to EU standards but with their own forms. Always check the current veterinary authority of your destination country. The [USDA Pet Travel page](https://www.aphis.usda.gov/pet-travel) provides current requirements for many countries.
...
**What works well:**
- Holiday apartments (Airbnb, Booking.com) — use the "pet-friendly" filter + ask the host directly
- Aparthotels and serviced residences — more privacy, your own kitchen
- Rural hotels and farm stays — often more cat-friendly than city hotels
- Camping (if you can secure the cat safely)

Search on [Booking.com](https://www.booking.com) with the "pets allowed" filter and read reviews from other cat owners. An extra fee of €10–25/night is normal.
...
Zercy helps you find the best pet-friendly hotels for your route. Save the options in the [Zercy Logbook](https://www.zercy.app/logbook).
