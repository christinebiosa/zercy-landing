---
title: "Positioning Flight: When Flying to a Cheaper Hub Actually Makes Sense"
metaTitle: "Positioning Flight: When the Feeder Flight Pays Off | Zercy"
description: "Hamburg to Frankfurt 89€ + Frankfurt to NYC 900€ = 989€ instead of 1,350€ direct. When a positioning flight actually pays off, how to calculate costs and what risks to plan for."
pubDate: 2026-05-25
...
Under the [EU Air Passenger Rights Regulation (EC) No 261/2004](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32004R0261), missed connection protection only applies when both flights are on the same booking or the same airline rerouted you. Separate bookings are not covered.
...
Zercy calculates routes including positioning flights and shows the total price. No manual math needed. Save your selection in the [Zercy Logbook](https://www.zercy.app/logbook) so you have all options ready when booking.
