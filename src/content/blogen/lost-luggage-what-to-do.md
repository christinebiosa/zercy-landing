...
The [International Air Transport Association](https://www.iata.org/en/programs/ops-infra/baggage/) publishes industry standards for baggage handling and rights.
...
- A list of all items in the bag with estimated current value (not retail price)
- Purchase receipts where available (realistic for expensive electronics or branded items)
- Photos of the bag and its contents (ideally taken before every flight)
