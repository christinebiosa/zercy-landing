...
**Top picks:** Grand Hotel Kempinski Riga (five-star directly on Livu Square), Wellton Old Riga Palace Hotel (boutique with historic character), Hotel Justus (small boutique hotel in a quiet alley). These and 350+ more Riga hotels with neighborhood filters are on [Booking.com](https://www.booking.com) with free cancellation.

The [official Riga tourism site](https://www.liveriga.com) has a current event calendar and neighborhood recommendations.
...
For Riga, [Booking.com](https://www.booking.com) is well stocked:

- 350+ Riga hotels with neighborhood filter
...
Tell Zercy what you are looking for in Riga: Art Nouveau architecture, old town charm, or affordable accommodation in a local neighborhood. You will get hotel suggestions in the right area with Booking links. Save the shortlist in your [Zercy Logbook](https://www.zercy.app/logbook) so you have all options handy when booking.
