...
const RULES = {
  de: [
    ...
    { re: /\bFlughafentransfers?\b/i, url: 'https://www.welcomepickups.com/', dom: 'welcomepickups.com' },
  ...
  en: [
    ...
    { re: /\bairport transfers?\b/i, url: 'https://www.welcomepickups.com/', dom: 'welcomepickups.com' },
  ...
  es: [
    ...
    { re: /\btraslado(s)? (al|del) aeropuerto\b/i, url: 'https://www.welcomepickups.com/', dom: 'welcomepickups.com' },
